-- code black lives mattered from Make Shotguns Great Again made by NikitaWasTaken https://github.com/nikitawastaken/msga

-- update 237 try not to ruin things challenge
Hooks:PostHook(ShotgunBase, "setup_default", "shotgunbase_setup_default", function(self)
